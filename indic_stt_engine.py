"""
Indic Conformer Multilingual STT Engine Module
Handles ai4bharat/indic-conformer-600m-multilingual model loading and transcription.
...
Reference implementation:
    ...
    transcription = model(wav, "bn", "ctc")

Notes:
    - torchaudio cannot natively load .webm on Windows; we use ffmpeg to convert
      the uploaded file to a temporary .wav before loading.
    - Inference is run in a thread-pool executor so it doesn't block the event loop.
"""
