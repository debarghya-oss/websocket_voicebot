...
TEMP_AUDIO_DIR = BASE_DIR / "temp_stt_audio_files"
...
INDIC_TARGET_SAMPLE_RATE = 16000  # Indic Conformer expects 16 kHz mono
...
DEFAULT_LMSTUDIO_TOP_K = int(os.getenv("DEFAULT_LMSTUDIO_TOP_K", "45"))
